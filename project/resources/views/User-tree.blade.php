...
<head>
   ...
   <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
    <link rel="stylesheet" href="css/user_tree_style.css">
            ...
            <div class="container">
                ...
                <div class="row align-items-center text">
                    ...
                    <div class=" col-8 col-lg-9 test1">
                            <p class="name">Andrew Wilson</p>
                            <p> 15 Jan 1985, Mons, Belgium &nbsp &nbsp &nbsp   Libra <i class="fas fa-mars"></i>&nbsp 33 y.o.</p>
                         </div>
                 </div>
                <div class="row link">
                    <div class="col-lg-1 text-center Users knopka">
                        <a class="link1" href="#">Info</a>
                     </div>
                    <div class="col-lg-1 text-center Users knopka">
                        <a class="link1" href="#">Company</a>
                     </div>
                    <div class="col-lg-3 text-center Users knopka">
                        <a class="link1" href="#">Individual Relationship</a>
                     </div>
