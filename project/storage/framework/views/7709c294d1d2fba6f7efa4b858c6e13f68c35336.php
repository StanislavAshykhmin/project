...
<head>
    ...
    <link href="<?php echo e(asset('css/user_tree_style.css')); ?>" rel="stylesheet">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <?php if(count($friend->childs)): ?>
                            <?php echo $__env->make('welcome', ['id' => $user->id], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                            <?php endif; ?>
                        </li>
